...
const findAllProduct = async (req,res) => {
    try {
      ...
      // console.log("hjkh",foundProducts)
...
const updateProduct = async (req,res) => {
    ...
    let {title,category,subCategory,price,tagLine,image,productImages,details,packageId,productUrl,productVideos,tags} = req.body;

     if(title||category||subCategory||price||tagLine||image||productImages||details||packageId||productUrl||productVideos||tags)
